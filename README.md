...
| AI 工具 | 技能目录 |
|---------|---------|
| Claude Code | `~/.claude/skills/amemo-skill` |
| Codex | `~/.codex/skills/amemo-skill` |
| OpenCode | `~/.opencode/skills/amemo-skill` |
| OpenClaw | `~/.openclaw/skills/amemo-skill` |
